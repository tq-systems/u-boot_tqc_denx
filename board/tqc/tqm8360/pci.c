...
#else
{
	...
	pci_pot[0].pocmr = POCMR_EN
	    | POCMR_SE | (POCMR_CM_256M & POCMR_CM_MASK);
	 ...
	 */
	pci_ctrl[0].pitar1 =
	    (CONFIG_SYS_PCI1_SLV_MEM_LOCAL >> 12) & PITAR_TA_MASK;
	pci_ctrl[0].pibar1 = (CONFIG_SYS_PCI1_SLV_MEM_BUS >> 12) & PIBAR_MASK;
	pci_ctrl[0].piebar1 = 0x0;
	pci_ctrl[0].piwar1 = PIWAR_EN
	    | PIWAR_PF | PIWAR_RTT_SNOOP | PIWAR_WTT_SNOOP | PIWAR_IWS_2G;
	...
	pci_set_region (hose[0].regions + 1,
			...
			CONFIG_SYS_PCI1_IO_SIZE, PCI_REGION_IO);

	/* PCI memory space */
	pci_set_region (hose[0].regions + 2,
			CONFIG_SYS_PCI1_MMIO_BASE,
			CONFIG_SYS_PCI1_MMIO_PHYS,
			CONFIG_SYS_PCI1_MMIO_SIZE, PCI_REGION_MEM);

	/* System memory space */
	pci_set_region (hose[0].regions + 3,
			CONFIG_SYS_PCI1_SLV_MEM_LOCAL,
			CONFIG_SYS_PCI1_SLV_MEM_BUS,
			CONFIG_SYS_PCI1_SLV_MEM_SIZE,
